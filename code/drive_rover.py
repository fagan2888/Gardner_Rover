...
class RoverState():   
    def __init__(self):
        ...
        #added other rover status objects 
        self.perception_count = 0 # Counter to keep track of map cleanup occurrence in XXX frames
        self.start_pos = None # Save starting position for return
        self.rock_pause = False # Pauses to count and stop redundant counts
        self.samples_collected = 0 # Counts till all 6 rocks are collected 
